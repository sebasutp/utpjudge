...
class ExcercisesControllerTest < ActionController::TestCase
  ...
  test "should create excercise" do
    assert_difference('Excercise.count') do
      post :create, :excercise => { :from_date => @excercise.from_date, :nombre => @excercise.nombre, :to_date => @excercise.to_date }
    end
  ...
  test "should update excercise" do
    put :update, :id => @excercise, :excercise => { :from_date => @excercise.from_date, :nombre => @excercise.nombre, :to_date => @excercise.to_date }
    assert_redirected_to excercise_path(assigns(:excercise))
  end
